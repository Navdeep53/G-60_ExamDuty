...
import 'package:flutter/services.dart'; // <- important for FilteringTextInputFormatter
...
class _BankDetailsScreenState extends State<BankDetailsScreen> {
  ...
  String? _accountMismatchError; // realtime mismatch message
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            "Enter your bank account details for exam duty honorarium payment",
                            style: TextStyle(
                              fontSize: 13,
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontWeight: FontWeight.w600,
                                          fontSize: 13.5,
                                          color: Color(0xFFB56C14),
                                        ),
                                      ),
                                      SizedBox(height: 3),
                                      Text(
                                        "Please ensure all details are accurate. Payments will be processed to this account.",
                                        style: TextStyle(
                                          fontSize: 12.3,
